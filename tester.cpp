...
char start_server(int PORT_NUMBER, string reply, int flag)
{
      int key_int;
...
int main(int argc, char *argv[]){
  ...
  int fd = open(argv[2], O_RDWR | O_NOCTTY | O_NDELAY | O_NONBLOCK);
  ...
  int i = 0;
    ...
    char val = start_server(PORT_NUMBER, temp, fl);
